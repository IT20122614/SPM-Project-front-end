...
export default function AddNewHotel() {
  ...
  function submitNewHotels(e) {
    ...
    axios
      .post("http://localhost:8081/api/v1/hotel/add-new", data)
      .then((result) => {
        console.log(result);
        ...
        {activeStep === steps.length ? (
          ...
          <React.Fragment>
            <div className="addNEwBottom">
              <form onSubmit={submitNewHotels} style={{marginLeft: '50px', marginRight: '50px', marginTop: '20px', marginBottom: '60px'}}>
                {activeStep + 1 === 1 && (
                  <table width="90%">
